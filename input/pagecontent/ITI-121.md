...
The Beneficiary Manager SHOULD support the following search parameters as defined on the [SearchParameter artifacts](artifacts.html#behavior-search-parameters):
