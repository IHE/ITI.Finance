...
### 2:3.121.2 Actor Roles

<p id ="t2:3.121.2-1" class="tableTitle"><strong>Table 2:3.121.2-1: Actor Roles</strong></p>
...
<figcaption id="f2.3.121.4-1"><strong>Figure 2:3.121.4-1: Interaction Diagram</strong></figcaption>
</figure>
<br clear="all"/>
...
The Beneficiary Manager will support the search parameters as defined in the [capability statement for InsurancePlan](CapabilityStatement-IHE.FAIS.BeneficiaryManager.html#InsurancePlan1-1).

The Beneficiary Requestor will support the search parameters as defined in the [capability statement for InsurancePlan](CapabilityStatement-IHE.FAIS.BeneficiaryRequestor.html#InsurancePlan1-1)
...
### 2:3.121.5 CapabilityStatement Resource
